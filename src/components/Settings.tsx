      ...
      <Tabs defaultValue="account" className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Input defaultValue="alex.smith@email.com" type="email" />
                </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input defaultValue="Software Engineer, Full Stack Developer, Backend Engineer" placeholder="Comma-separated roles" />
              </div>

              <div>
                <label className="text-sm font-medium">Preferred Locations</label>
                <Input defaultValue="San Francisco, New York, Remote" placeholder="Comma-separated locations" />
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">New job matches and suggestions</p>
                  </div>
                  <Switch 
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Allow anonymous progress data sharing</p>
                  </div>
                  <Switch 
        ...
        <TabsContent value="preferences" className="space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <p className="text-sm text-muted-foreground">Reduce spacing in interface</p>
                    <Switch />
                  </div>
                </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-medium">Default Study Session</label>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-medium">Auto-start Next Task</h4>
                  <p className="text-sm text-muted-foreground">Automatically begin next study task</p>
                </div>
                <Switch />
              </div>
        ...
        <TabsContent value="data" className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Download all your data including progress, applications, and generated documents.
              </p>
              
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div>
                    <h4 className="font-medium">Profile & Progress Data</h4>
                    <p className="text-sm text-muted-foreground">Personal info, skills, and learning progress</p>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Job applications and tracking information</p>
                  </div>
                  <Button size="sm" variant="outline">
                    <Download className="h-4 w-4 mr-2" />
                    Export
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Cover letters, emails, and tailored resumes</p>
                  </div>
                  <Button size="sm" variant="outline">
                    <Download className="h-4 w-4 mr-2" />
                    Export
          ...
          <Card className="border-destructive">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div>
                  <h4 className="font-medium">Clear Learning Data</h4>
                  <p className="text-sm text-muted-foreground">
                    Reset all progress, completed tasks, and study history. This cannot be undone.
                  </p>
                ...
                <div>
                  ...
                  <Button size="sm" variant="destructive" className="mt-2 gap-2">
