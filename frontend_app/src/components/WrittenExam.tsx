...
export function WrittenExam() {
  ...
  const examTypes = [
    ...
    },
    {
      ...
      description:
        "Comprehensive evaluation (MCQ + written + code/system design as needed)",
      sections: [
        "Core CS",
        "Role Skills",
        "SQL",
  ...
  const questionBank = [
    {
      ...
      section: "Core CS",
      question:
        "Time complexity of inserting at beginning of dynamic array?",
    ...
    },
    {
      ...
      question:
        "Explain difference between horizontal and vertical scaling with one advantage each.",
    ...
    },
    {
      ...
      type: "code",
      section: "Coding",
      question: "Return second largest element in an array.",
      placeholder:
    ...
    },
    {
      ...
      type: "short",
      section: "SQL",
      question: "Describe an index and when NOT to use one.",
    ...
    },
    {
      ...
      section: "System Design",
      question:
        "CAP theorem: which can be traded off in network partition?",
      options: [
        "Consistency",
        "Availability",
        "Partition Tolerance",
    ...
    },
    {
      ...
      section: "Coding",
      question:
        "Output of sorting algorithm stability refers to?",
      options: [
        "Time complexity",
        "Keeps equal keys order",
        "Uses less memory",
        "Parallelizable",
      ],
      correct: "Keeps equal keys order",
    },
  ];
  ...
  const allowedTypes = useMemo(() => {
    ...
    if (selectedExam === "standard")
      return ["mcq", "short", "code"];
    return ["mcq"];
  }, [selectedExam]);
    ...
    weakAreas: [
      {
        ...
        score: 60,
        recommendation:
          "Review threading and synchronization concepts",
      },
      {
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Standard Assessment - Google SWE Role
            </p>
          </div>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1 space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  You performed well above average. Your
                  strongest areas are data structures and
                  algorithm analysis. Focus on concurrency and
                  database optimization for improvement.
                </p>
                <div className="flex gap-2">
    ...
    return (
      <div className="h-full overflow-auto p-6 space-y-6">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex gap-2">
            <Button variant="outline">Save & Skip</Button>
            {currentQuestion ===
    ...
    <div className="h-full overflow-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Test your skills with JD-aligned assessments
          </p>
        </div>
      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="p-3 rounded-md bg-muted/50 text-xs space-y-1 border">
              <p>
                ...
                {selectedExam === "quick"
                  ? "MCQ Only"
                  : "Mixed (MCQ + Short + Code)"}
              </p>
              <p className="text-muted-foreground">
                Questions will be pulled only from the sections
                you select above.
              </p>
            </div>
